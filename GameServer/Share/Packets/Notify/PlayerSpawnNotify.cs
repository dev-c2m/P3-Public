...
{
    class PlayerSpawnNotify : Packet
    {
        public override PacketType Type => PacketType.PlayerSpawnNotify;
        ...
        public PlayerSpawnNotify() { }
        public PlayerSpawnNotify(int playerId, string nickname, float x, float y, float z, float rotationY,
