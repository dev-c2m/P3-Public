...
{
    class ItemUseResponse : Packet
    {
        public override PacketType Type => PacketType.ItemUseResponse;
        ...
        public ItemUseResponse(bool isSuccess, int slotIndex, int remainingQuantity, string message = "")
        {
            IsSuccess = isSuccess;
            SlotIndex = slotIndex;
